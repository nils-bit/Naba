        ...
        {active.map((project) => (
          <div key={project.id}>
            {editingId === project.id ? (
              ...
              <div className="flex items-stretch bg-white/72 backdrop-blur-xl rounded-2xl border border-black/[0.06] shadow-sm transition-all duration-200 hover:shadow-md overflow-hidden">
                <div
